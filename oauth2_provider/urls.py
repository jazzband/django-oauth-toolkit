...
management_urlpatterns = [
    ...
    url(r"^applications/(?P<pk>[0-9^/]+)/$", views.ApplicationDetail.as_view(), name="detail"),
    url(r"^applications/(?P<pk>[0-9^/]+)/delete/$", views.ApplicationDelete.as_view(), name="delete"),
    url(r"^applications/(?P<pk>[0-9^/]+)/update/$", views.ApplicationUpdate.as_view(), name="update"),
    # Token management views
    url(r"^authorized_tokens/$", views.AuthorizedTokensListView.as_view(), name="authorized-token-list"),
    url(r"^authorized_tokens/(?P<pk>[0-9^/]+)/delete/$", views.AuthorizedTokenDeleteView.as_view(),
